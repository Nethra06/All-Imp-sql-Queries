...
/****** Object:  StoredProcedure [dbo].[IndexOptimize]    Script Date: 11/21/2016 12:32:30 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
  ...
  IF @Error <> 0
  BEGIN
    SET @ErrorMessage = 'The documentation is available at MSDN' + CHAR(13) + CHAR(10) + ' '
    RAISERROR(@ErrorMessage,16,1) WITH NOWAIT
    SET @ReturnCode = @Error
    GOTO Logging
  END
