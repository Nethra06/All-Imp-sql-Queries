...
/****** Object:  StoredProcedure [dbo].[CommandExecute]    Script Date: 11/21/2016 12:33:49 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
  ...
  BEGIN
    SET @ErrorMessage = 'The table CommandLog is missing. RUN INDEX OPTIMZA SCRIPT FIRST' + CHAR(13) + CHAR(10) + ' '
